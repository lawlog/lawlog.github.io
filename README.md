...
文档数据（`content`目录中）来自：[🔗 国家法律法规数据库](https://flk.npc.gov.cn/search)，
使用`markitdown`将`docx`文件转化为`markdown`格式，并进行适当格式化处理，文本内容仅供参考，如有问题，可以提交 issue。
...
- 网站 LOGO 修改自 [🔗 svgrepo.com](https://www.svgrepo.com/ "justice")
- 背景图片来自网络。
- 搜索功能尚未完善，搜索结果不太准确。
- 评论系统：Giscus、Disqus
...
- [ImCa0/just-laws](https://github.com/ImCa0/just-laws)
  ...
  ![commit](https://img.shields.io/github/last-commit/ImCa0/just-laws)
- [LawRefBook/Laws](https://github.com/LawRefBook/Laws)
  ![stars](https://img.shields.io/github/stars/LawRefBook/Laws)
  ![commit](https://img.shields.io/github/last-commit/LawRefBook/Laws)
...
- [🔗 北大法宝·法律法规数据库](https://www.pkulaw.com/law)
  - [🔗 北大法宝·中国法律检索系统](https://law.pkulaw.com/)
